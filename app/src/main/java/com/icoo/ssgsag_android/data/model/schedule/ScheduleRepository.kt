...
interface ScheduleRepository {
    fun getAllCalendar(sortType: Int? = 1): Single<ArrayList<Schedule>>
    fun getCalendar(year: String, month: String, date: String, sortType: Int? =1): Single<ArrayList<Schedule>>
    fun getFavoriteCalendar(year: String, month: String, date: String,  sortType: Int? =1): Single<ArrayList<Schedule>>
