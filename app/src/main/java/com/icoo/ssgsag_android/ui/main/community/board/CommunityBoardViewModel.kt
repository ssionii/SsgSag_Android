...
class CommunityBoardViewModel(
    ...
    val dummuyAllCounselList = arrayListOf(
        ...
        CommunityBoardPostDetail(0, "취업/진로", 2, "취업 진로 관련 게시글 1", "설명이다 와라랄랄라 과연 어떻게 끊길까? 밍밍밍밍밍밍밍밍밍밍", 30, 10,"1시간 전", "https://img.theqoo.net/img/RVyXA.jpg" ),
        ...
        CommunityBoardPostDetail(0, "취업/진로", 2, "취업 진로 관련 게시글 2", "설명이다 와라랄랄라 과연 어떻게 끊길까? 밍밍밍밍밍밍밍밍밍밍", 30, 10,"1시간 전", "https://img.theqoo.net/img/RVyXA.jpg" ),
